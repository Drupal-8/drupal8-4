...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    ...
    <div class="default-content">
        <div class="container">
            <div class="case-overview-heading">
                <?php print @$node->body['und'][0]['value']; ?>
            </div>
        </div>
    </div>
    <div class="case-fullpage-image"><div class="container text-center"><?php echo render($content['field_case_image']); ?></div></div>
        <?php _custom_paragraphs_displays($content); ?>
