...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    <div class="main-webform-content">
        ...
        <div class="default-content">
            <?php
            print $node->field_body['und'][0]['value'];
            ?>
        </div>
    </div>
    <div class="node-webform container">
        <div class="webform-first col-md-6 col-sm-6 col-xs-12 col-md-offset-1">
            <div class="form-heading-wraper">
            <?php
            echo $node->field_addtional_info['und'][0]['value'];
            ?>
            </div>
            <?php
        ...
        <div class="message-form col-md-4 col-sm-5 col-xs-12">
            <?php
